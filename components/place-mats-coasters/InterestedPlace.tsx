...
export default function InterestedPlace() {
  return (
    <div className="w-full flex flex-col px-[200px] pt-[35px] pb-[64px] bg-white">
      <div className="space-y-[20px] pb-[20px]">
        ...
        <p className="font-normal text-[20px] leading-[26px] text-black">
          To get your plaque created, reach out to me today TESTTTTTT
        </p>
      </div>
